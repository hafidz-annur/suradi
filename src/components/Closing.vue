...
<template>
  <v-container height="100dvh" class="relative p-0">
    ...
    >
      ...
      >
        <p class="text-[14px]">
          Kami berharap momen penuh syukur ini semakin lengkap dan bermakna
          dengan kehadiran serta doa restu dari Bapak/Ibu/Saudara/i. <br>
          Wassalamu’alaikum warahmatullahi wabarakatuh.
        </p>
      </div>
      <div
        class="absolute bottom-[15vh] left-0 w-full"
        data-aos="fade-up"
        data-aos-delay="1000"
      >
